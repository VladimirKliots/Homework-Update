...
namespace UnitTestProject1
{
    ...
    public class UnitTest1
    {
        ...
        {
            Assert.AreEqual(SomeClass.Chyslo("сто двадцять три мільйони чотириста п'ятдесят шість мільйонів сімсот вісімдесят вісім тисяч триста дванадцять"), 123456788312);
        }
        [TestMethod]
        public void TestMethod9()
        {
            Assert.AreEqual(SomeClass.Chyslo("мільйон мільйон"), -1);
        }
        [TestMethod]
        public void TestMethod11()
        {
            Assert.AreEqual(SomeClass.Chyslo("три мільйони"), 3000000);
        }
    }
