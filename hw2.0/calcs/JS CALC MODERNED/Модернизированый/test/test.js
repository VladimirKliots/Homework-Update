describe("function summ", function() {
    ...
    it("call function summ with args memoryNumber = 0.0000001, countNumber = 1 and return 1.0000001", function () {
	 ...
	 it("call function summ with args memoryNumber = -8.9, countNumber = '2' and return '-6.9' ", function () {
        const a = -8.9;
        const b = 2;
        const exp = -6.9;
        const act = summ(a, b);
    ...
    it("call function summ with args memoryNumber = '-8.9', countNumber = '2' and return 'не число' ", function () {
	 ...
	 it("call function summ with one arg memoryNumber = -8.9 and return 'не число' ", function () {
        const a = 8.9;
        const b = null;
        const exp = 8.9;
        const act = summ(a, b);
	 ...
	 it("call function summ with one arg countNumber = 2 and return 'не число' ", function () {
        const a = null;
        const b = 2;
        const exp = 2;
        const act = summ(a, b);
	...
	it("call function summ with no args  return 'не число' ", function () {
		const a = null;
		const b = null;
        const exp = 0;
        const act = summ(a, b);
...
describe("function minus", function() {
	...
	it("call function minus with args memoryNumber = 4.9, countNumber = 1.1 and return 3.8", function () {
        const a = 4.9;
        const b = 1.1;
        const exp = 3.8;
        const act = minus(a, b);
    ...
    it("call function minus with args memoryNumber = -3232, countNumber = 3234 and return -6466", function () {
        const a = -3232;
        const b = 3234;
        const exp = -6466;
        const act = minus(a, b);
    ...
    it("call function minus with args memoryNumber = -8.9, countNumber = '2' and return 'не число' ", function () {
	 ...
	 it("call function minus with one arg memoryNumber = -8.9 and return 'не число' ", function () {
        const a = 8.9;
        const b = null;
        const exp = 8.9;
        const act = minus(a, b);
	 ...
	 it("call function minus with one arg countNumber = 2 and return 'не число' ", function () {
        const a = null;
        const b = 2;
        const exp = -2;
        const act = minus(a, b);
	...
	it("call function minus with no args  return 'не число' ", function () {
		const a = null;
		const b = null;
        const exp = 0;
        const act = minus(a, b);
...
describe("function multiply", function() {
    ...
    it("call function multiply with args memoryNumber = -8.9, countNumber = '2' and return 'не число' ", function () {
	 ...
	 it("call function multiply with one arg memoryNumber = -8.9 and return 'не число' ", function () {
        const a = 8.9;
        const b = null;
        const exp = 0;
        const act = multiply(a, b);
	 ...
	 it("call function multiply with one arg countNumber = 2 and return 'не число' ", function () {
        const a = null;
        const b = 2;
        const exp = 0;
        const act = multiply(a, b);
	...
	it("call function multiply with no args  return 'не число' ", function () {
		const a = null;
		const b = null;
        const exp = 0;
        const act = multiply(a, b);
...
describe("function divide", function() {
    ...
    it("call function divide with args memoryNumber = -8.9, countNumber = '2' and return 'не число' ", function () {
	 ...
	 it("call function divide with one arg memoryNumber = -8.9 and return 'не число' ", function () {
        const a = 8.9;
        const b = null;
        const exp = Infinity;
        const act = divide(a, b);
	 ...
	 it("call function divide with one arg countNumber = 2 and return 'не число' ", function () {
        const a = null;
        const b = 2;
        const exp = 0;
        const act = divide(a, b);
	...
	it("call function divide with no args  return 'не число' ", function () {
		const a = null;
		const b = null;
        const exp = NaN;
        const act = divide(a, b);
    ...
    describe("function cutDisplay", function() {
        ...
        it("call function cutDisplay with args a = 0.143456789 and return 0.1434567 symbols", function () {
            const a   = '0.143456789';
            const exp = 0.1434567;
            const act = cutDisplay(a);
